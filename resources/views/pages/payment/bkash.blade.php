                ...
                <div class="col-lg-7 "  style="border-right: 1px solid grey; padding: 20px;">
                 ...
                 <div class="col-lg-5 " style=" padding: 20px;">
                    <div class="contact_form_container">
                        <div class="contact_form_title text-center">Pay Now By Bkash
                     <img src="{{ asset('public/frontend/images/Bkash.svg') }}" style="width: 100px; height: 60px;"> 
                        <div>
                        	@php

                        	 $bkashCharge = ((18.85/1000) *  Cart::Subtotal())
                        	@endphp
                        	<h3>Please pay total of Tk  <strong> {{ ceil(Cart::Subtotal() + $charge + $bkashCharge) }} (including bkash charge of {{ $bkashCharge }}tk)</strong> to <strong>01914103956</strong> </h3>
                        </div>
                        ...
                        <form action="{{ route('bkash.charge') }}" method="post" id="payment-form" style="border: 1px solid grey; padding: 20px;">
		                 ...
		                 <div class="form-group">
		                  ...
		                  <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Transaction Number" name="bkash_trx_no">
		                </div>
