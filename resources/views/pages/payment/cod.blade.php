                ...
                <div class="col-lg-7 "  style="border-right: 1px solid grey; padding: 20px;">
                 ...
                 <div class="col-lg-5 " style=" padding: 20px;">
                    <div class="contact_form_container">
                        <div class="contact_form_title text-center">Pay Now By Cash
                     <img src="{{ asset('public/frontend/images/cod.png') }}" style="width: 100px; height: 60px;"> 
                        <div>
                        	<h3>Please pay total of Tk  <strong> {{ Cart::Subtotal() + $charge }} </strong> to <strong> Hand-Cash</strong> </h3>
                        </div>
