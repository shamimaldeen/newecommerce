                 ...
                 <div class="col-lg-5 " style=" padding: 20px;">
                    <div class="contact_form_container">
                        ...
                        <form action="{{ route('payment.process') }}" id="contact_form" method="post">
                           ...
                           <div class="form-group">
                                <ul class="logos_list " >
                                            <li><input type="radio" name="payment" value="cod"> <img src="{{ asset('public/frontend/images/cod.png') }}" style="width: 100px; height: 60px;"></li> <li><input type="radio" name="payment" value="bkash"> <img src="{{ asset('public/frontend/images/Bkash.svg') }}" style="width: 100px; height: 60px;"></li>
