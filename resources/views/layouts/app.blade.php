...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        ...
                        <div class="logos ml-sm-auto">
                            <ul class="logos_list">
                                <li><a href="#"><img  style="width: 50px;height: 60px;" src="{{ asset('public/frontend/images/BKash.svg') }}" alt=""></a></li>
                                <li><a href="#"><img style="width: 50px;height: 60px;"src="{{ asset('public/frontend/images/cod.png') }}" alt=""></a></li>
